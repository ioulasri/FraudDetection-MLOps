...
class DataSplitter:
    ...
    def split(self, df: pd.DataFrame, target_col: str = 'Class') -> Tuple[pd.DataFrame, pd.DataFrame, pd.DataFrame]:
        """
        Split data into train, validation, and test sets.
    ...
    def load_splits(self, input_dir: str = 'data/splits') -> Tuple[pd.DataFrame, pd.DataFrame, pd.DataFrame]:
        """

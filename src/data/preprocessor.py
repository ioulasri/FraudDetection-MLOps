...
class DataCleaner:
    ...
    def clean(self, df: pd.DataFrame, remove_duplicates: bool = True,
              missing_strategy: str = 'drop', outlier_columns: Optional[List[str]] = None) -> pd.DataFrame:
        """
...
class FeatureEngineer:
    ...
    def add_statistical_features(self, df: pd.DataFrame, pca_columns: Optional[List[str]] = None) -> pd.DataFrame:
        """
